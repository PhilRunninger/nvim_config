...
hi({
    ...
    DiffAdd =        {fg = c.green,   bg = c.gray13,   bold = 1, italic = 1},
    DiffChange =     {fg = c.blue,    bg = c.gray13,   bold = 1, italic = 1},
    DiffDelete =     {fg = c.red,     bg = c.gray13,   bold = 1, italic = 1},
    DiffText =       {fg = c.yellow,  bg = c.gray13,   bold = 1, italic = 1},
    EndOfBuffer =    {},
