...
let s:bg1    = isDark ? '#1c1c1c': '#e0e0e0'
let s:bg2    = isDark ? '#383838': '#c4c4c4'
let s:bg3    = isDark ? '#545454': '#a8a8a8'
let s:bg4    = isDark ? '#707070': '#8c8c8c'
let s:fg4    = isDark ? '#8c8c8c': '#707070'
let s:fg3    = isDark ? '#a8a8a8': '#545454'
let s:fg2    = isDark ? '#c4c4c4': '#383838'
let s:fg1    = isDark ? '#e0e0e0': '#1c1c1c'
let s:fg0    = isDark ? '#ffffff': '#000000'
let s:grey   = isDark ? '#928374': '#928374'
let s:red    = isDark ? '#ef2929': '#cc0000'
let s:orange = isDark ? '#fe8019': '#ff5f00'
let s:yellow = isDark ? '#fce94f': '#c4a000'
let s:green  = isDark ? '#8ae234': '#4e9a06'
let s:aqua   = isDark ? '#34e2e2': '#06989a'
let s:blue   = isDark ? '#729fcf': '#3465a4'
let s:purple = isDark ? '#ad7fa8': '#75507b'
...
call s:HiLite(#{
    ...
    \ Todo:           #{fg: s:fg0,   bg: s:bg0, bold: 1, italic: 1},
