...
local options = {
    ...
    number = true,
    relativenumber = true,
    fillchars = {stl=' ', stlnc=' ', eob=' ', fold='_'},
    foldtext = 'printf("%s  %s%s",getline(v:foldstart)->substitute("\\\\s*".&commentstring->substitute("%s",".*",""),"",""),repeat("_",v:foldlevel),tr(v:foldend-v:foldstart+1,"0123456789","₀₁₂₃₄₅₆₇₈₉"))',
    list = true,
